    ...
    "relative group border text-foreground mx-auto text-center rounded-full",
    {
        variants: {
            variant: {
                ...
                solid: "bg-white hover:bg-neutral-200 text-black border-transparent hover:border-black/50 transition-all duration-200",
                ghost: "border-transparent bg-transparent hover:border-white/50 hover:bg-white/10",
            },
            size: {
                default: "px-7 py-1.5 ",
                sm: "px-4 py-0.5 ",
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, neon = true, size, variant, as: Component = "button", children, ...props }, ref) => {
        return (
            <Component
